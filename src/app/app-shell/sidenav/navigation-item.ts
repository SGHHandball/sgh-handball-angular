...
export const NAVIGATION_ITEMS_GEN_INFOS = [
  new NavigationItem([TC_ROUTE_CONTENT, TC_ROUTE_EXECUTIVES].join("/"), TC_ROUTE_EXECUTIVES),
  new NavigationItem([TC_ROUTE_CONTENT, TC_ROUTE_REFEREES].join("/"), TC_ROUTE_REFEREES),
  new NavigationItem([TC_ROUTE_CONTENT, TC_ROUTE_TIME_KEEPER].join("/"), TC_ROUTE_TIME_KEEPER),
  new NavigationItem([TC_ROUTE_CONTENT, TC_ROUTE_CDH].join("/"), TC_ROUTE_CDH),
